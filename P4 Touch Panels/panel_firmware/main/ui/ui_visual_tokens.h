...
/** Shared accent (yellow–orange): selected text, and solid fills for "on" tiles. */
#define UI_ACCENT_COLOR lv_color_hex(0xFFAA22)
/** Label color to use on top of a solid `UI_ACCENT_COLOR` fill. */
#define UI_ACCENT_TEXT_COLOR lv_color_black()
...
#define UI_SINGLE_SELECTOR_TEXT_COLOR_SELECTED UI_ACCENT_COLOR
/**
